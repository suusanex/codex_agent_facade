---
name: github-copilot
description: Codex 上のユーザー本文を Codex Agent Facade の MCP tool start_agent / get_agent_job 経由で GitHub Copilot CLI へ渡す。この Codex thread で GitHub Copilot に実装させたいときに使う。
user-invocable: true
